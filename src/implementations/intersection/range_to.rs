...
impl<T: Copy + Ord> RangeIntersection<T, std::ops::Range<T>> for std::ops::RangeTo<T> {
...
impl<T: Copy + Ord> RangeIntersection<T, std::ops::RangeFrom<T>> for std::ops::RangeTo<T> {
    type Output = BoundedRange<T>;
...
impl<T> RangeIntersection<T, std::ops::RangeFull> for std::ops::RangeTo<T> {
...
impl<T: Copy + Ord> RangeIntersection<T, std::ops::RangeInclusive<T>> for std::ops::RangeTo<T> {
    type Output = BoundedRange<T>;
...
impl<T: Copy + Ord> RangeIntersection<T, std::ops::RangeTo<T>> for std::ops::RangeTo<T> {
    type Output = UpperBoundedRange<T>;
...
impl<T: Copy + Ord> RangeIntersection<T, std::ops::RangeToInclusive<T>> for std::ops::RangeTo<T> {
    type Output = UpperBoundedRange<T>;
...
impl<T: Copy + Ord> RangeIntersection<T, BoundedRange<T>> for std::ops::RangeTo<T> {
    type Output = BoundedRange<T>;
...
impl<T: Copy + Ord> RangeIntersection<T, LowerBoundedRange<T>> for std::ops::RangeTo<T> {
    type Output = BoundedRange<T>;
...
impl<T: Copy + Ord> RangeIntersection<T, UpperBoundedRange<T>> for std::ops::RangeTo<T> {
    type Output = UpperBoundedRange<T>;
...
impl<T> RangeIntersection<T, UnboundedRange<T>> for std::ops::RangeTo<T> {
    type Output = UpperBoundedRange<T>;
